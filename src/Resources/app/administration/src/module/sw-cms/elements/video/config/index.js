...
Component.register('sw-cms-el-config-video', {
    ...
    computed: {
        ...
        uploadTag() {
            return `cms-element-video-config-media-${this.element.id}`;
        },

        previewUploadTag() {
            return `cms-element-video-config-media-preview-${this.element.id}`;
        }
    },
    ...
    methods: {
        ...
        updateElementData(media = null) {
            ...
            if(this.element.data.media) {
                if(this.element.data.media.fileExtension !== "mp4") {
                    this.onMediaRemove();
                }
            }
        },
